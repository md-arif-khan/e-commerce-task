...
const SignUp = () => {
    const {createUser,googleSignIn,updateDisplayName}=useContext(AuthContext)
            ...
            <div class="overflow-hidden bg-white rounded-md shadow-md">
                <div class="px-4 py-6 sm:px-8 sm:py-7">
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-base text-gray-600">Don’t have one? <Link to='/login' title="" class="text-blue-600 transition-all duration-200 hover:underline hover:text-blue-700">Already have an account</Link></p>
                    </div>
                    ...
                    <form onSubmit={handleSignUp} class="mt-8">
                        <div class="space-y-5">
                            <div>
                                ...
                                <div class="mt-2.5">
                                    <input type="text" name="name" id="" placeholder="Enter your name" class="block w-full p-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
                                </div>
                            </div>
                            ...
                            <div>
                                <input class="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-md focus:outline-none hover:bg-blue-700 focus:bg-blue-700" type="submit" value="Sign Up" />
